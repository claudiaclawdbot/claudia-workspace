...
**Status:** 🔄 **PARTIALLY COMPLETE** - 8 scripts standardized, ~12 remaining
...
**Remaining:**
- agent-claudia/*.sh (3 files: daily-github-update.sh, recursive-prompt.sh, today.sh, worker.sh)
- Various root-level scripts

**Effort:** 20 min (3 min remaining)  
